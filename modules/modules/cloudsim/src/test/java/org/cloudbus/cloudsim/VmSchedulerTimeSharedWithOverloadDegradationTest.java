 ...
 */
public class VmSchedulerTimeSharedWithOverloadDegradationTest {

	private static final double MIPS = 1000;

	private VmSchedulerTimeSharedWithOverloadDegradation vmScheduler;
	...
	public void setUp() throws Exception {
		...
		vmScheduler = new VmSchedulerTimeSharedWithOverloadDegradation(peList);
	...
	public void testAllocatePesForVmShortageEqualsToAllocatedMips() {
		...
		VmScheduler vmScheduler = new VmSchedulerTimeSharedWithOverloadDegradation(peList);
