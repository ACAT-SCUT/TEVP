 ...
 */
//每个host都会有一个PeProvisioner，用于管理该host上的Mips对Vm的分配操作
//并记录具体给Vm的vCPU分配了多少mips（一个Vm的多个vCPU可能分配在同一个Pe里面）
public abstract class PeProvisioner {
	...
	public abstract List<Double> getPeTableForVm(Vm vm);

	public abstract List<Double> getPeTableByVmUid(String VmUid);
