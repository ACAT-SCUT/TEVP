...
public interface PowerModel {
	...
	double getPeff(double utilization) throws IllegalArgumentException;
	double[] getPowerList() throws IllegalArgumentException;
	double[] getPeffList() throws IllegalArgumentException;
	double getPp_CPU_tuil()throws IllegalArgumentException;
	double getPeakPeff() throws  IllegalArgumentException;
	double getPeakPower() throws  IllegalArgumentException;
}
