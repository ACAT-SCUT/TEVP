 ...
 */
//这个类表示Host的“物理内核”，注意和VM的vCPU区分，vCPU只是一个概念，并没有抽象成具体的一个类
//仅仅由CloudletScheduler的List：currentMipsShare表示，vCPU的其他详细信息其实都在
//CloudletSchedulerDynamicWorkload里面表示出来了，所以并没有专门给它开辟成新的类
public class Pe {
    ...
    public int getAvailableMips() {
        return (int) getPeProvisioner().getAvailableMips();
    }//修改点
