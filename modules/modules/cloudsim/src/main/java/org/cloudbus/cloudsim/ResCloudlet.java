...
public class ResCloudlet {
	...
	public long cloudletFinishedSoFar;//修改点
	...
	public void finalizeCloudlet() {
		...
		double wallClockTime = CloudSim.clock() - arrivalTime;//从Cloudlet到来该VM到Cloudlet完成的时间
		...
		//这里不知道合不合理（如果Cloudlet放置给多个Vm的话，那可能他就是想记录历史以来到现在完成的length吧？）
