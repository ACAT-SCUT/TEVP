...
public class MadMmt {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFolder = MadMmt.class.getClassLoader().getResource("workload/Mix").getPath();
		String outputFolder = "output";
		inputFolder = URLDecoder.decode(inputFolder, "UTF-8");//解决中文路径问题

		Constants.vmAllocationPolicy = "mad"; // Median Absolute Deviation (MAD) VM allocation policy
		Constants.vmSelectionPolicy = "mmt"; // Minimum Migration Time (MMT) VM selection policy
