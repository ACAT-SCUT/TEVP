...
public class MadMc {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFolder = MadMc.class.getClassLoader().getResource("workload/Mix").getPath();
		...
		Constants.vmSelectionPolicy = "mc"; // Maximum Correlation (MC) VM selection policy
