...
public class SingleAlgorRunInScale {
...
//    private static String[] dates = {"vm-5000-1","vm-5000-2","vm-5000-3","vm-5000-4","vm-5000-5"};
    ...
    private static int[] cloudlets = {1516};
    public static void main(String[] args) throws IOException {
        for(int i=0;i<dates.length;i++){
            Constants.workload= dates[i];
            Constants.NUMBER_OF_CLOUDLETS=cloudlets[i];
            Constants.NUMBER_OF_VMS=cloudlets[i];
//            Ffd ffd = new Ffd();
//            ffd.main(null);
//            System.gc();
